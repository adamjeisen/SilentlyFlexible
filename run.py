...
if __name__ == '__main__':
    ...
    # SYNAPTIC
    # ===================================================
    sim = simulation.Simulation(T=2000, N_sensory_nets=8, N_sensory=512, N_rand=1024, amp_ext=1200,
                                amp_ext_nonspecific=0, amp_ext_background=1,
                                amp_ext_nonspecific_rand=0, amp_ext_stim_rand=5, amp_ext_background_rand=0.5,
