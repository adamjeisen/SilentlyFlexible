...
if __name__ == '__main__':
    ...
    #                  amp_ext_nonspecific_rand=5, amp_ext_stim_rand=10, amp_ext_background_rand=0, tau_d=200, tau_f=2000, ux_mod=2, u_init=0.2)
    sim = simulation.Simulation(T=1500, N_sensory_nets=8, N_sensory=512, N_rand=1024, amp_ext=1200,
                                amp_ext_nonspecific=0, amp_ext_background=0.5,
                                amp_ext_nonspecific_rand=0, amp_ext_stim_rand=10, amp_ext_background_rand=0.3, tau_d=200,
                                tau_f=2000, ux_mod=2, u_init=0.2)
